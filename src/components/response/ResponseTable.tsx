  ...
  return (
    <>
      ...
      <div className="mt-6 overflow-hidden rounded-xl border border-gray-200 shadow-sm bg-white">
        {/* Toolbar */}
        <div className="flex items-center justify-end px-4 py-2 border-b border-gray-200 bg-gray-50 space-x-2">
          <button
      ...
      {/* Fullscreen Modal */}
      {isFullscreen && (
        <div className="fixed inset-0 z-50 bg-white bg-opacity-70 flex items-center justify-center p-6">
